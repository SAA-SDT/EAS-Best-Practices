...
**Scope Note:**
To identify the different parts of a physical address eg for public access or to contact and/or communicate with someone by postal services.
...
Scope notes for following terms sourced from:

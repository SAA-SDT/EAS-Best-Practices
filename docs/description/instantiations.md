...
**Context:**
Encoding of individual instantiations of the described records, including digital representations, microfiches, analogue copies, and similar formats.
...
- digitized surrogates of analogue originals,
- born‑digital records with various derivative formats,
- preservation masters, access copies, and other technical variants.

In EAD 4.0, the intellectual description of an archival unit - whether expressed in `<archDesc>` or within a component `<c>` - comes with additional sibling elements that identify, contextualize, and describe the provenance, history, and relationships of the material. Information relating to each of the analogue, digital or hybrid instantiations of the described material is documented separately within `<formsAvailable>`, using elements intended for recording characteristics of the carrier, format, or technical properties.
...
<img width="1280" height="720" alt="Image" src="/images/599897030-ff726c82-04e5-4e33-848b-0293696ec763.png" />
